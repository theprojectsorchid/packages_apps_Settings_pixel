...
@SearchIndexable
public class CustomizeDashboard2 extends SettingsPreferenceFragment { 
    ...
    public void onCreate(Bundle icicle) {
		...
		if (afterLabsStyle() == 1) {
			addPreferencesFromResource(R.xml.customize_system_dashboard_grid);
			//Category Pref//
    ...
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
            new BaseSearchIndexProvider() {
                ...
                public List<SearchIndexableResource> getXmlResourcesToIndex(
                    ...
                    sir.xmlResId = R.xml.customize_system_dashboard_grid;
