...
public class AdaptiveRestrictedPreference extends RestrictedPreference {
    ...
    public AdaptiveRestrictedPreference(Context context, AttributeSet attrs,
        ...
        super(context, attrs, defStyleAttr, defStyleRes, packageName, uid);
        init(context, attrs);
    }
    ...
    public AdaptiveRestrictedPreference(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public AdaptiveRestrictedPreference(Context context) {
        super(context);
    }

    public AdaptiveRestrictedPreference(Context context, String packageName, int uid) {
